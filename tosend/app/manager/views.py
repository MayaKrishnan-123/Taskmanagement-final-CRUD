...
@manager.route('/taskmanager/add', methods=['GET', 'POST'])
@login_required
def add_task():
    """
...
@manager.route('/taskmanager/edit/<int:id>', methods=['GET', 'POST'])
@login_required
def edit_task(id):
    """
    Edit a task
...
@manager.route('/taskmanager/delete/<int:id>', methods=['GET', 'POST'])
@login_required
def delete_task(id):
    """
...
@manager.route('/taskmanager/showall', methods=['GET','POST'])
@login_required
def list_task():
